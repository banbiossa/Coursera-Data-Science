...
# <Organizing you analysis>
# write what you did to the raw data
# exploratory figures: put there what's useful
# final figures: beautiful, and conpact
# raw scripts: most go unpublished
# final scripts: commented, details 
# r markdown: summary
# readme: if you don't use markdown
# text document: story, reference
